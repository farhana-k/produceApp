...
export CORE_PEER_ADDRESS=10.0.2.15:7003
export CORE_PEER_TLS_ROOTCERT_FILE=/vars/keyfiles/peerOrganizations/govt.agro.com/peers/peer1.govt.agro.com/tls/ca.crt
export CORE_PEER_LOCALMSPID=govt-agro-com
export CORE_PEER_MSPCONFIGPATH=/vars/keyfiles/peerOrganizations/govt.agro.com/users/Admin@govt.agro.com/msp
...
jq '.channel_group.groups.Application.groups."govt-agro-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "10.0.2.15","port": 7003}]},"version": "0"}}' agrochannel_current_config.json > agrochannel_modified_anchor_config.json
