...
jq '.channel_group.groups.Application.groups."farmer-agro-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "10.0.2.15","port": 7004}]},"version": "0"}}' agrochannel_current_config.json > agrochannel_modified_anchor_config.json
