...
let oked=0
let total=0
declare -a allpeernodes=(peer1.govt.agro.com peer1.farmer.agro.com peer1.buyer.agro.com)
...
declare -a allorderernodes=(orderer1.agro.com orderer2.agro.com orderer3.agro.com)
