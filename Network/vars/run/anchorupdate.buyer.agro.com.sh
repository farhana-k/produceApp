...
export ORDERER_ADDRESS=10.0.2.15:7010
export ORDERER_TLS_CA=/vars/keyfiles/ordererOrganizations/agro.com/orderers/orderer2.agro.com/tls/ca.crt
...
jq '.channel_group.groups.Application.groups."buyer-agro-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "10.0.2.15","port": 7005}]},"version": "0"}}' agrochannel_current_config.json > agrochannel_modified_anchor_config.json
